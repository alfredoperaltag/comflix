        ...
        <div class="collapse navbar-collapse" id="it-menu">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              <a href="#" class="nav-link dropdown-toggle" id="menu-categorias" data-toggle="dropdown" aria-haspopup="true" aria-expand="false"><?php echo $_GET['categoria']; ?></a>
      ...
      <div class="row mt-3 mb-3">
        <div class="col mt-5">
          <div class="card-columns">
            ...
            $result=mysqli_query($conn,"SELECT Archivos.idArchivos,archivos.poster,archivos.nombre,archivos.descripcion,categorias.nombreCategoria FROM archivos inner join categorias on archivos.idcategoria = categorias.idCategoria WHERE categorias.nombreCategoria = \"".$_GET['categoria']."\"");
            ...
            <div class="card border-danger ">
              ...
              <div class="card-body">
                ...
                <p class="card-text"><?php echo $extraido['descripcion']; ?></p>
              </div>
            </div>
            <?php } ?>
